                        ...
                        <div className={styles.searchBar}>
                            <div className={styles.searchInput}>
                                ...
                                >
                                    ...
                                    <g>
                                        <path
                                            d="M11.407,10.421,8.818,7.832a4.276,4.276,0,1,0-.985.985l2.589,2.589a.7.7,0,0,0,.985-.985ZM2.355,5.352a3,3,0,1,1,3,3,3,3,0,0,1-3-3Z"></path>
                                    </g>
                                </svg>
            ...
            <>
                <header className={styles.header}>
                    <div className={styles.container}>
                        ...
                        <nav className={styles.nav}>
                            <Link to={`/supplier-homepage/${currentUser.supplierProfileId}`} className={styles.navLink}>
                                Profile
                            </Link>
